...
function formatRelatorioFromResponse(relatorio: any): RelatorioFinanceiro {
  return {
    ...
    meses: relatorio.meses.map((mes: any) => ({
      ...
      recebimentoLocacoesGeradores: parseFloat(mes.recebimentoLocacoesGeradores) || 0,
      ...
      pagamentosComprasInsumos: parseFloat(mes.pagamentosComprasInsumos) || 0,
      pagamentosLocacoesGeradores: parseFloat(mes.pagamentosLocacoesGeradores) || 0,
